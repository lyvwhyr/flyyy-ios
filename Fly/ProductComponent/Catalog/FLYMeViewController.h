...
@protocol FLYMeViewControllerDelegate <NSObject>

- (void)everythingElseCellTapped:(FLYUniversalViewController *)vc type:(FLYEverythingElseCellType)type;

@end

@interface FLYMeViewController : FLYUniversalViewController

@property (nonatomic) id<FLYMeViewControllerDelegate>delegate;
