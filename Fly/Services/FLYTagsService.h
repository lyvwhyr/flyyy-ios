...
typedef void(^FLYAutoCompleteTagsSuccessBlock)(AFHTTPRequestOperation *operation, id responseObj);
typedef void(^FLYAutoCompleteErrorBlock)(id responseObj, NSError *error);
